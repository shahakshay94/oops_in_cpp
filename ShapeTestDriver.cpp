...
void drawHouseEarlyBinding() {
    ...
    Oblique triangle_above_front_door(8, "triagle door top");
    triangle_above_front_door.draw(poster, 24, 22, '*'); // triagle door top
    ...
    cout << triangle_above_front_door << endl;
    cout << doggyDoor << endl;
